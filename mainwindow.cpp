...
void GraphicsScene::setSizeSceneBlock(const QSize &sizeScene, const QSize &sizeBlock)
{
    /**/
    sizeS = sizeScene;
    sizeB = sizeBlock;
...
//вычисляем из координат курсора координаты узла
